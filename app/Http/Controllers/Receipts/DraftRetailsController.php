...
use App\Http\Requests\Receipts\DraftUpdateRequest;
use Illuminate\Http\Request;

class DraftRetailsController extends DraftReceiptsController
{
    ...
    public function update(DraftUpdateRequest $receiptForm, $receiptKey)
    {
    ...
    public function store(Request $request, $receiptKey)
    {
        ...
        $newReceipt->charged_on = $receipt->charged_on;
        ...
        $newReceipt->costs_detail = [
            'base_charge'    => $receipt->base_charge,
            'discount'       => $receipt->discount,
            'subtotal'       => $receipt->subtotal,
            'insurance_cost' => $receipt->insurance_cost,
            'packing_cost'   => $receipt->packing_cost,
            'add_cost'       => $receipt->add_cost,
            'admin_fee'      => $receipt->admin_fee,
            'total'          => $receipt->total,
        ];
