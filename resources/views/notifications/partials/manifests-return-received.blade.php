...
@if ($isPageContent)
    ...
    <div>Manifest Pengembalian ({{ $notification->data['title'] }}) telah diterima oleh Cabang Pengirim</div>
@else
<a style="white-space:normal" href="{{ route('manifests.returns.show', [$notification->data['title'], 'source'=>'notif', 'notif_id' => $notification->id]) }}">
    ...
    <div class="small">Manifest Pengembalian ({{ $notification->data['title'] }}) telah diterima oleh Cabang Pengirim</div>
</a>
@endif