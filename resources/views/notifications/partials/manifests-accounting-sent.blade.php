...
@if ($isPageContent)
    ...
    <p>Manifest Akunting ({{ $notification->data['title'] }}) telah dikirim ke Bagian Akunting</p>
@else
<a style="white-space:normal" href="{{ route('manifests.accountings.show', [$notification->data['title'], 'source'=>'notif', 'notif_id' => $notification->id]) }}">
    ...
    <p class="small">Manifest Akunting {{ $notification->data['title'] }} telah dikirim ke Bagian Akunting</p>
</a>
@endif