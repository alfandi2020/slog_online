...
@if ($isPageContent)
    ...
    <div>Manifest Serah Terima ({{ $notification->data['title'] }}) telah diterima oleh Warehouse</div>
@else
<a style="white-space:normal" href="{{ route('manifests.handovers.show', [$notification->data['title'], 'source'=>'notif', 'notif_id' => $notification->id]) }}">
    ...
    <div class="small">Manifest Serah terima ({{ $notification->data['title'] }}) telah diterima oleh Warehouse</div>
</a>
@endif