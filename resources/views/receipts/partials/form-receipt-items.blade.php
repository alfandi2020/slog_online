    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                {!! link_to_route('receipts.draft', trans('app.done'), [$receipt->receiptKey, 'step' => 1], ['class'=>'btn btn-success']) !!}
                {{-- {!! FormField::delete(['route'=>'receipt-items.destroy','class'=>'empty-items pull-right'], 'Kosongkan Receipt Items', ['title'=>'Kosongkan Item','class'=>'btn btn-danger'], ['instance'=>request('cat')]) !!} --}}
            </div>
        </div>
    </div>
</div>
