<div class="panel panel-default table-responsive hidden-xs">
    <table class="table table-condensed table-bordered">
        <tr>
            <td class="col-xs-2 text-center">{{ trans('cash_invoice.number') }}</td>
...
<ul class="list-group visible-xs">
    <li class="list-group-item">{{ trans('cash_invoice.number') }} <span class="pull-right">{{ $invoice->number }}</span></li>
