...
@section('title', __('report.time_series.time_series').': '.__('report.time_series.invoice'))

@section('content')
<div class="well well-sm">
    <h3 class="pull-left" style="margin-top: 4px; margin-bottom: 0px;">{{ __('report.time_series.invoice') }}</h3>
    ...
    {!! link_to_route('reports.time_series.invoice', __('report.this_year'), [], ['class' => 'btn btn-default']) !!}
    {!! Form::close() !!}
</div>
